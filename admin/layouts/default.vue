...
<script>
    import AdminHeader from "../components/partails/AdminHeader";
    import AdminSidebar from "../components/partails/AdminSidebar";
    import MobileHeader from "../components/partails/MobileHeader";
